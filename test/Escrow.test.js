...
describe("Escrow", () => {
  ...
  beforeEach(async () => {
    ...
    escrow = await Escrow.deploy(realEstate.getAddress(), seller.address, inspector.address, lender.address)

    // Approve property
    // we will be make seller approve to change status from property
  ...
  describe("Approval", () => {
    it("Updates approval status", async () => {
      let transaction = await escrow.approveSale(1);
      await transaction.wait()
